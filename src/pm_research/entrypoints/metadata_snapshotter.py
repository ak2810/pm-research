...
from pm_research.metadata.markets_snapshotter import MarketsSnapshotter
...
async def main() -> None:
    ...
    writer = RawWriter("pm_meta", cfg.data_dir)
    heartbeat = Heartbeat(
        "pm-metadata-snapshotter",
        cfg.healthchecks_url,
        cfg.discord_webhook_url,
    )
    snapshotter = MarketsSnapshotter(
        writer=writer,
        interval_s=cfg.gamma_discovery_interval_s,
